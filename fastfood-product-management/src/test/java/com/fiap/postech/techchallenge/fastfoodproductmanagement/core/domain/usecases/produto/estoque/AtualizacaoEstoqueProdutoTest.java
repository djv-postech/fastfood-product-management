...
class AtualizacaoEstoqueProdutoTest {
    ...
    @Test
    public void devePermitirAtualizarEstoqueEmUmProdutoDoCatalogo(){
        //Arrange
        ...
        //Act
        Produto produtoEstoque = atualizacaoEstoqueProduto.atualizar(1, 10);
